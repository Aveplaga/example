                ...
                <div class="header-wrapper">
                    <div class="header-wrapper__content">
                        <a href="#" class="header-logo">
                            <img src="./local/assets/images/header-logo.svg" alt="Логотип компании Шёлковый путь">
                            <div class="header-logo__text">
                                <span class="header-logo__text--top">Группа компаний</span>
                                <span class="header-logo__text--title">Шёлковый путь</span>
                            </div>
                        </a>
                        <div class="header-calls">
                            <div class="header-calls__item">
                                <svg class="header-calls__item--icon" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="header-calls__item--text">
                                    <a href="#" class="header-calls__item--text__addresses">
                                        Благовещенск
                                        <svg width="4" height="4" viewBox="0 0 4 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M4 1L2 3L0 1L4 1Z" fill="#4D4D4D" />
                                        </svg>
                                    </a>
                                    <a href="tel:89145572414" class="header-calls__item--text__tels">8 914 557 24 14</a>
                                </div>
                            </div>
                            <div class="header-calls__item header-calls__item--hidden">
                                <svg class="header-calls__item--icon" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M11.3333 8.33333C10.5 8.33333 9.7 8.2 8.95333 7.95333C8.72 7.88 8.46 7.93333 8.27333 8.11333L6.80667 9.58C4.92 8.62 3.37333 7.08 2.41333 5.18667L3.88 3.71333C4.06667 3.54 4.12 3.28 4.04667 3.04667C3.8 2.3 3.66667 1.5 3.66667 0.666667C3.66667 0.3 3.36667 0 3 0H0.666667C0.3 0 0 0.3 0 0.666667C0 6.92667 5.07333 12 11.3333 12C11.7 12 12 11.7 12 11.3333V9C12 8.63333 11.7 8.33333 11.3333 8.33333ZM10.6667 6H12C12 2.68667 9.31333 0 6 0V1.33333C8.58 1.33333 10.6667 3.42 10.6667 6ZM8 5.95833H9.33333C9.33333 4.11833 7.84 2.625 6 2.625V3.95833C7.10667 3.95833 8 4.85167 8 5.95833Z" fill="#FFD98C" />
                                </svg>

                                <div class="header-calls__item--text">
                                    <a href="#" class="header-calls__item--text__addresses">Пекин</a>
                                    <a href="tel:8618810009070" class="header-calls__item--text__tels">86 18810009070</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="header-buttons">
                        <button type="button" class="header-button__contacts">Связаться с нами</button>

                        <button type="button" class="header-button__menu">
                            ...
                            <span class="header-button__menu--title">Меню</span>
                        </button>
                    </div>
                </div>
            </div>
                    ...
                    <ul class="header-list">
                        <li class="header-item">
                            <a href="" class="header-link">
                                <img src="./local/assets/images/Services.svg" alt="Иконка услуги" class="header-link__logo">
                                <span class="header-link__title">Услуги</span>
                            </a>
                        </li>
                        <li class="header-item">
                            <a href="" class="header-link">
                                <img src="./local/assets/images/Expert.svg" alt="Иконка экспертность" class="header-link__logo">
                                <span class="header-link__title">Экспертность</span>
                            </a>
                        </li>
                        <li class="header-item">
                            <a href="#about" class="header-link">
                                <img src="./local/assets/images/Company.svg" alt="Иконка о компании" class="header-link__logo">
                                <span class="header-link__title">О компании</span>
                            </a>
                        </li>
                        <li class="header-item">
                            <a href="" class="header-link">
                                <img src="./local/assets/images/Feedback.svg" alt="Иконка отзывы" class="header-link__logo">
                                <span class="header-link__title">Отзывы</span>
                            </a>
                        </li>
                        <li class="header-item">
                            <a href="" class="header-link">
                                <img src="./local/assets/images/Clients.svg" alt="Иконка клиенты" class="header-link__logo">
                                <span class="header-link__title">Клиенты</span>
                            </a>
                        </li>
                        <li class="header-item">
                            <a href="" class="header-link">
                                <img src="./local/assets/images/Contacts.svg" alt="Иконка контакты" class="header-link__logo">
