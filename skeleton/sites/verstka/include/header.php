                ...
                <div class="header-wrapper">
                    <div class="header-content">
                        ...
                        <a href="#" class="header-logo">
                            <img src="./local/assets/images/logo.svg" alt="Логотип">
                        </a>
                        <nav class="header-menu">
                            <ul class="header-list">
                                <li class="header-item">
                                    <a href="#" class="header-link">Логистика</a>
                                </li>
                                <li class="header-item dropdown-list">
                                    ...
                                    <ul class="hidden-list">
                                        <li class="hidden-item">
                                            <a href="#" class="hidden-link">Поиск и выкуп товара</a>
                                        </li>
                                        <li class="hidden-item">
                                            <a href="#" class="hidden-link">Доставка товара из Китая</a>
                                        </li>
                                        <li class="hidden-item">
                                            <a href="#" class="hidden-link">Денежные переводы в Китай</a>
                                        </li>
                                        <li class="hidden-item">
                                            <a href="#" class="hidden-link">Консталтинговые Услуги</a>
                                        </li>
                                        <li class="hidden-item">
                                            <a href="#" class="hidden-link">Заказ образцов товаров</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="header-item">
                                    <a href="#" class="header-link">Заказ</a>
                                </li>
                                <li class="header-item dropdown-list">
                                    <a href="#" class="header-link">
                                        Компания
                        ...
                        <div class="header-blank">
                            ...
                            <a href="#" class="blank-link">Бланк заказа</a>
                        </div>
                        <div class="header-call">
                            <p class="call-title">Бесплатный зовнок по Рф</p>
                            <a href="#" class="call-phone">8 800 555 55 35</a>
                        </div>
                    </div>
                    <a href="#" class="header-application">Оставить заявку</a>
